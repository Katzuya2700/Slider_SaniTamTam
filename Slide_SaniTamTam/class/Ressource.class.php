<?php
    ...
    class Ressource {
        ...
        private $tab; // Tableau qui ne contient que les valeurs du tableau interne spécifique (titre, date)
        ...
        /********** 
         * 
         * Méthode qui créer un dossier du nom de "ressources", si il n'existe pas
         * 
         * Contante CHEMIN_DOSSIER_RESSOURCES => chemin du dossier ciblé (config.php / CONSTANTES DANS LE FICHIER RESSOURCE.CLASS.PHP)
         * 
         * A noté que le dossier est crée en 751 pour avoir une meilleurs sécurité
         * 
         **********/
        public function creerDossier() {

            if (!file_exists(CHEMIN_DOSSIER_RESSOURCES)) {
                mkdir(CHEMIN_DOSSIER_RESSOURCES, 0751);
            }
        }
